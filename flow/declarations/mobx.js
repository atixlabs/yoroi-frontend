declare module 'mobx' {
  ...
  declare export type IObservableMapInitialValues<V> = IMapEntries<V> | KeyValueMap<V> | IMap<string, V>

  declare export interface IReactionOptions {
    context?: any,
  ...
  declare export interface IInterceptable<T> {
    interceptors: IInterceptor<T>[] | any,
    intercept(handler: IInterceptor<T>): Lambda
  }

  declare export type ITransformer<A, B> = (object: A) => B

  declare export type IInterceptor<T> = (change: T) => T

  declare export type IMapEntry<V> = [string, V]

  declare export type IMapEntries<V> = IMapEntry<V>[]
  ...
  declare export interface IComputedValueOptions<T> {
    compareStructural?: boolean,
    name?: string,
    setter?: (value: T) => void,
    context?: any
  ...
  declare export interface IComputed {
  ...
  declare export interface IDependencyTree {
    name: string,
    dependencies?: IDependencyTree[]
  }

  declare export interface IObserverTree {
    name: string,
    observers?: IObserverTree[]
  }

  declare export interface IAtom { }

  declare export interface IComputedValue<T> {
    get(): T,
    set(value: T): void,
  ...
  declare export interface IDepTreeNode {
    name: string,
    observing?: IObservable[]
  }

  declare export interface IDerivation {
    name: string,
    observing: IObservable[],
  ...
  declare export interface IReactionPublic {
    dispose: () => void
  }
  ...
  declare export interface IObservableArray<T> extends Array<T> {
  ...
  declare export interface IArrayChange<T> {
    type: "update",
  ...
  declare export interface IArraySplice<T> {
    type: "splice",
    object: IObservableArray<T>,
    index: number,
    added: T[],
  ...
  declare export interface IArrayWillChange<T> {
    type: "update",
    object: IObservableArray<T>,
    index: number,
    newValue: T
  ...
  declare export interface IArrayWillSplice<T> {
    type: "splice",
    object: IObservableArray<T>,
    index: number,
    added: T[],
  ...
  declare export type KeyValueMap<V> = {
    [key: string]: V
  }

  declare export interface IMapChange<T> {
  ...
  declare export interface IMapWillChange<T> {
    object: ObservableMap<T>,
    type: "update" | "add" | "delete",
    name: string,
    newValue?: any
  ...
  declare export interface IObservableObject { }

  declare export interface IObjectChange {
    name: string,
    object: any,
    type: "update" | "add",
    oldValue?: any,
  ...
  declare export interface IObjectWillChange {
    object: any,
    type: "update" | "add",
    name: string,
    newValue: any
  ...
  declare export interface IValueWillChange<T> {
    object: any,
    type: "update",
    newValue: T
  }

  declare export interface IValueDidChange<T> extends IValueWillChange<T> {
    oldValue: ?T
  }
  ...
  declare export interface IEnhancer<T> {
    (newValue: T, oldValue: T | void, name: string): T,
  }

  declare export interface IModifierDescriptor<T> {
    isMobxModifierDescriptor: boolean,
    initialValue: T | void,
    enhancer: IEnhancer<T>,
  }

  declare export interface IObservableFactory {
  ...
  // This breaks Flow bevcause it overwrites another type named the same.
  ...
  declare export interface Lambda {
    (): void,
    name?: string
  }

  declare export interface IActionFactory {
