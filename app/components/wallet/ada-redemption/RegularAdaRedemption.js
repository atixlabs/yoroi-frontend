...
import styles from './RegularAdaRedemption.scss';
...
const submitOnEnter = () => {};
const FORM_VALIDATION_DEBOUNCE_WAIT = 6;
const ADA_REDEMPTION_PASSPHRASE_LENGTH = 8;
...
@observer
export default class RegularAdaRedemption extends Component<Props> {
